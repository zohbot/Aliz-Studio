...
The Playwright suite covers the landing page, service package routing, security headers, booking validation, availability rule filtering, mock checkout completion, owner dashboard status management, owner service/menu management, owner availability management, and owner customer records across desktop and mobile viewports.
